...
def main():
    ...
    ax.set_ylabel("Richesse predite (ResNet-18)")
    ...
    ax.set_ylabel("R²")
    ax.set_title(f"R² par fold (moy = {r2_mean:.3f}, sd = {r2_std:.3f})")
    ax.set_xticks([1])
